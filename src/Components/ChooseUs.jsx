...
function ChooseUs() {
  return (
    <div className='lg:h-[90vh] md:h-[140vh] sm:h-[150vh] h-[220vh] relative mt-96 lg:mt-0 top-0 w-full flex lg:flex-row flex-col pt-20 md:px-0 px-10'>
        ...
        <div className='lg:w-[50%] lg:h-[100%] md:w-full h-[50%] lg:px-20 md:px-48 lg:text-left text-center md:pt-16 sm:pt-0 md:-mt-16 sm:-mt-20 -mt-56'>
