...
function ChooseUs() {
  return (
    <div className='lg:h-[90vh] md:h-[140vh] sm:h-[150vh] h-[220vh] relative lg:-top-96 top-0 mt-96 border-orange-300 w-full flex lg:flex-row flex-col pt-20 md:px-0 px-10'>
        <div className='lg:w-[50%] lg:h-[100%] w-full h-[50%] lg:pl-48 lg:px-0 md:px-52 lg:text-left text-center'>
            ...
            <h1 className='xl:text-[2.5rem] md:text-[2rem] font-bold sm:mb-10 mb-6 leading-tight'>Discover exceptional value with our unbeatable deals.</h1>
        ...
        <div className='lg:w-[50%] lg:h-[100%] md:w-full h-[50%] lg:px-20 md:px-48 lg:text-left text-center md:pt-16 sm:pt-20 -mt-16'>
